...
public class FilteredClassifier extends DistributionClassifier
  ...
  /** The classifier */
  protected Classifier m_Classifier = new weka.classifiers.NaiveBayesSimple();

  /** The filter */
  protected Filter m_Filter = new weka.filters.DiscretizeFilter();
  ...
  public FilteredClassifier() {
    ...
    this(new weka.classifiers.NaiveBayesSimple(), 
	 new weka.filters.DiscretizeFilter());
  }
