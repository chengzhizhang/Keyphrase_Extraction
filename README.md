...
<b>Note</b>: △P, △R, △F<sub>1</sub> denotes: The difference of Precise, Recall and F<sub>1</sub> values of keyphrase extraction betweend corpus with [title, abstract and reference information] and corpus with only [title and abstract information, respectively].
