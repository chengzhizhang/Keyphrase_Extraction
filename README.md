...
&nbsp&nbsp<li>title: The title the paper.
&nbsp&nbsp<li>abstract: The abstract the paper.
&nbsp&nbsp<li>keywords: the keywords of the paper and these keywords were annotated manually.
&nbsp&nbsp<li>references: references list and only the title of each reference is provided.
